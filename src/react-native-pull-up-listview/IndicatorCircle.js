...
class IndicatorCircle extends React.Component {
  ...
  generateCircleLines() {
    ...
    for (let i = 0; i < linesNum; i++ ) {
      ...
      const lineWrapperRotateStyle = {
        height: this.wrapperSize,
        width: this.wrapperSize,
        transform: [
          {
  ...
  render() {
    ...
    this.wrapperSize = this.props.size === 'large' ? 36 : 28;

    return (
      <View style={[styles.container, {height: this.wrapperSize, width: this.wrapperSize}]}>
