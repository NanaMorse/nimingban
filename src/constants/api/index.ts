...
export const API_GET_ARTICLE_LIST = (id, page: number) => `${HOST}/Api/showf?id=${id}&page=${page}&${APP_ID_QUERY}`;

export const API_GET_REPLY_LIST = (id, page: number) => `${HOST}/Api/thread?id=${id}&page=${page}&${APP_ID_QUERY}`;
...
export const API_QUERY_FEED = (uuid, page: number) => `${HOST}/Api/feed?uuid=${uuid}&page=${page}&${APP_ID_QUERY}`;
